...
extern void
similarityScore_ompparallel_outlined(long long int, long long int, long long int, int *, int *, maxpos_t *, char *,
                                     char *, long long int, const int, const int, const int);
...
//#ifdef DEBUG
    ...
    for (int i = 1; i <= nDiag; ++i)
    {
        ...
        {
            similarityScore_ompparallel_outlined(si, sj, nEle, H, P, &maxPos, a, b, m, MATCH_SCORE, MISSMATCH_SCORE, GAP_SCORE);
